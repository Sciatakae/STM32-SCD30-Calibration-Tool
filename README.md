...
This project is a good example if you are learning about I2C and/or UART; or if you just want to calibrate your SCD30 using an STM32 board.

- On boot, a menu in the terminal appears and you can start/stop streaming the sensors data with ASC calibration enabled/disabled at your discression.
